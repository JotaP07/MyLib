 ...
 * @author joaop
 */
public class TbLendings extends javax.swing.JPanel {
    ...
    private void ConultarTempoReal(){
            ...
            model.setRowCount(0);
            List<LendingsM> itemList = dao.listar(txtFpesquisar.getText().trim());
    ...
    private void LoadItems() {
        try {
            ...
            DefaultTableModel model = (DefaultTableModel) tbItems.getModel();
            model.setRowCount(0);
            List<LendingsM> itemList = dao.listar("");
            for (LendingsM item : itemList) {
                model.addRow(new Object[]{
                    item.getId(),
                    item.getNomeFuncionario(),
    ...
    private void initComponents() {
        ...
        if (tbItems.getColumnModel().getColumnCount() > 0) {
            tbItems.getColumnModel().getColumn(0).setPreferredWidth(5);
            tbItems.getColumnModel().getColumn(1).setPreferredWidth(30);
            tbItems.getColumnModel().getColumn(4).setResizable(false);
            tbItems.getColumnModel().getColumn(4).setPreferredWidth(20);
        }
        ...
        title.setText("EMPRÉSTIMOS");

        deleteButton.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        deleteButton.setText("EMPRESTAR");
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        Dashboard.ShowJPanel(new Lendings());
