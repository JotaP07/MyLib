...
public class UpItems extends javax.swing.JPanel {
    ...
    private void InitStyles() {
        ...
        txtTipo.putClientProperty("JTextField.placeholderText", "Insira o Título do Item.");

        label3.setForeground(new Color(40, 42, 54));
        label3.putClientProperty("FlatLaf.styleClass", "large");
        txtTitulo.putClientProperty("JTextField.placeholderText", "Insira o ano de Publicação.");
